...
namespace SQLHelperDB.HelperClasses
{
    internal class SimpleSelectFinder : SqlCodeObjectVisitor
    {
        ...
        { codeObject.Children.ForEach(x => x.Accept(this)); }
        ...
        public override void Visit(SqlDistinctPredicateComparisonBooleanExpression codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }
        ...
        public override void Visit(SqlJsonObjectArgument codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }
        ...
        public override void Visit(SqlModuleInlineOption codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }
        ...
        public override void Visit(SqlNullQualifier codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }
        ...
        public override void Visit(SqlWindowClause codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }

        //
        // Summary:
        //     Visit SqlWindowExpression
        public override void Visit(SqlWindowExpression codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }

        //
        // Summary:
        //     Visit SqlWindowSpecification
        public override void Visit(SqlWindowSpecification codeObject)
        { codeObject.Children.ForEach(x => x.Accept(this)); }
